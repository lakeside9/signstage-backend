...
/**
 * {@link OptionalFeaturePricePeriod}(선택옵션 판매가격 기간)의 생성/수정/삭제 이력. append-only다
 * — {@link BillingPlanPricePeriodHistory}와 같은 패턴.
 */
@Entity
@Table(name = "optional_feature_price_period_histories")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@Immutable
public class OptionalFeaturePricePeriodHistory extends BaseEntity {
    ...
    @Builder
    private OptionalFeaturePricePeriodHistory(OptionalFeature optionalFeature, OptionalFeaturePricePeriod period, boolean removed) {
